...
<body>
	...
	<?php
		...
		if($signedOn){
	?>
		<h4>Hello Abby Welcome Back to DMACC</h4>
	...
	?>
		<?php  
			...
			$validForm = false;   // form has errors or not
		?>
		<form>
			...
			<p>
				<label>Username: 
					<input type="text"> <span 
											<?php 
												if($validForm){  // if validForm is true
													echo "";     // no message
												}
												else{			// else its false
													echo "class = 'errorMessage'";  //echo errorMessage
												}
												?> 
												>  <!-- end opening span tag -->
										</span>
				</label>
			</p>
			<p>
